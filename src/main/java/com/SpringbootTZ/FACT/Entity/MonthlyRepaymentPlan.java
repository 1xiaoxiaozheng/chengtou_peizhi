...
public class MonthlyRepaymentPlan {
    /**
     * 表单信息
     * 表单名称：	项目按月还款计划表
     * 所属应用：	人事审批
     ...
     * field0005	 	DECIMAL	 	20	 	数字1	 	文本	 	DECIMAL
    ...
    public class MainTable {
        ...
        private String firld0023;   //流水号
        private String field0024;    // 是否添加明细表
    }

    @Data
    @TableName("formson_0145")
    public class DetailTable1 {
